...
class Footer extends Component {
  ...
  render() {
    return (
    <FooterLayout className="Mobilefooter" background="light-2" pad="small" style={footerStyle}>
      <div className="footerBox">
        <img src={footerLogo} alt="footer_logo" className="footer-logo" style={{marginRight: '15px'}}/>
    ...
    <div className="footerBox">
          <div className="InfoBox" style={{marginRight: '15px'}}>
          <p><b>주소</b></p>    
          ...
          <div className="InfoBox MobileIcon">
