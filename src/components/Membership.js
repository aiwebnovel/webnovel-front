...
class Membership extends Component {
  ...
  async requestPay(plan, imp_uid, merchant_uid) {
    ...
    if (user !== undefined) {
      axios.post(`${config.SERVER_URL}/pay`, { 
        imp_uid: imp_uid, 
    ...
    return (
      <div class='pricingDiv'>
          ...
          <Modal open={ this.state.showMenu } close={ this.closeModal } title="Price">
            <a class='pricebutton' onClick={this.onClickPayment} name="html5_inicis">일반결제</a>
            <a class='pricebutton' onClick={this.onClickPayment} name="kakaopay">카카오</a>
          </Modal>
